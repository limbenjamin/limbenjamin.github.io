...
function validateRequiredST(form) {                                    
    var bValid = true;
    var focusField = null;
    var i = 0;                                                                                          
    var fields = new Array();                                                                           
    oRequired = new requiredST();                                                                         
                                                                                                        
    for (x in oRequired) { 
    	if ( ((form[oRequired[x][0]].type == 'checkbox') && !(form[oRequired[x][0]].checked)) ||
    	     ((form[oRequired[x][0]].type == 'text' || form[oRequired[x][0]].type == 'textarea' || form[oRequired[x][0]].type == 'select-one' || form[oRequired[x][0]].type == 'radio' || form[oRequired[x][0]].type == 'password') && form[oRequired[x][0]].value == '') 
    	   ) {
           if (i == 0)
              focusField = form[oRequired[x][0]]; 
...
function validateRequiredBTInvest(form) {                                    
    var bValid = true;
    var focusField = null;
    var i = 0;                                                                                          
    var fields = new Array();                                                                           
    oRequired = new requiredBTInvest();                                                                         
