  ...
  Drupal.behaviors.longform_render = {
    attach: function (context, settings) {
      ...
      window.addEventListener('load', function(event) {
        ...
        if (window.matchMedia("(min-width: 740px)").matches && document.querySelector('body.article-type-longform')) {
          if (!window.canRunAds && document.querySelector('.highlighted.sticky-nav-padding')) {
