...
function checkUserExists() {    
    $.get('/webauthn2/user/' + state.user.name, {}, null, 'json')
...
function getCredentials() {
    $.get('/webauthn2/credential/' + state.user.name, {}, null, 'json')
        .done(function (response) {
...
function makeCredential() {
    ...
    swal({
        ...
        imageUrl: "/webauthn2/images/securitykey.min.svg",
    ...
    $.get('/webauthn2/makeCredential/' + state.user.name, {attType: attestation_type, authType: authenticator_attachment}, null, 'json')
